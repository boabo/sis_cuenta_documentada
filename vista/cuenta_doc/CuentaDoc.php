    ...
    Phx.vista.CuentaDoc = Ext.extend(Phx.gridInterfaz, {
        ...
        constructor: function (config) {
            ...
            this.addButton('ini_estado', {
                ...
                tooltip: '<b>Retorna la Solicitud al estado borrador</b>'
            });
            ...
            this.addButton('chkpresupuesto', {
                text: 'Chk Presupuesto', grupo: [0, 1, 2, 3, 4],
                iconCls: 'blist',
                disabled: true,
        ...
        Atributos: [
            ...
            },
            {
                config: {
                    ...
                    gwidth: 50,
                    renderer: function (value, p, record) {
                        return String.format('{0}', record.data['desc_funcionario_cuenta_bancaria']);
                    }
                },
                type: 'ComboRec',
                id_grupo: 1,
            ...
            if (rec.data.estado == 'vbtesoreria' && rec.data.sw_solicitud == 'si') {
                configExtra = [
                    {
                        config: {
                            ...
                            baseParams: {
                                ...
                                modulo: 'LB',
                                id_depto_origen: rec.data.id_depto
                            }
                        },
                        type: 'ComboRec',
                        form: true
                ...
                this.eventosExtra = function (obj) {
                    obj.Cmp.id_depto_lb.on('select', function (data, rec, ind) {
                        ...
                        this.Cmp.id_cuenta_bancaria.store.baseParams = {
                            'tipo_interfaz': me.tipo_interfaz,
                            par_filtro: 'nro_cuenta',
                            'permiso': 'fondos_avance',
                            id_depto_lb: obj.Cmp.id_depto_lb.getValue()
                        };
                        this.Cmp.id_cuenta_bancaria.modificado = true;


                        this.Cmp.id_depto_conta.reset();
                        this.Cmp.id_depto_conta.store.baseParams = {
                            tipo_filtro: 'DEPTO_UO',
                            estado: 'activo',
                            codigo_subsistema: 'CONTA',
                            id_depto_origen: obj.Cmp.id_depto_lb.getValue()
                        };
