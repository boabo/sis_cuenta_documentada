...
/**
 *@package pXP
 *@file CuentaDocRenConsulta.php
 *@author  Gonzalo Sarmiento
 *@date 31-08-2016
 *@description Archivo con la interfaz de usuario que permite
 *listar las rendiciones
 *
 */
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
    Phx.vista.CuentaDocRenConsulta = {
        bedit:false,
        bnew:false,
        bsave:false,
        bdel:true,
        ...
        nombreVista: 'CuentaDocRenConsulta',
        ...
        constructor: function(config) {
            ...
            Phx.vista.CuentaDocRenConsulta.superclass.constructor.call(this,config);
            this.init();
        ...
        preparaMenu:function(n){
            ...
            var tb =this.tbar;
            Phx.vista.CuentaDocRenConsulta.superclass.preparaMenu.call(this,n);
        ...
        loadValoresIniciales: function() {
            ...
            Phx.vista.CuentaDocRenConsulta.superclass.loadValoresIniciales.call(this);
            this.Cmp.id_cuenta_doc_fk.setValue(this.id_cuenta_doc);
        },

        onButtonNew : function() {
            Phx.vista.CuentaDocRenConsulta.superclass.onButtonNew.call(this);
