...
FROM cd.tcuenta_doc cd
     ...
     LEFT JOIN orga.tfuncionario_cuenta_bancaria fcb ON
         fcb.id_funcionario_cuenta_bancaria = cd.id_funcionario_cuenta_bancaria
     JOIN orga.tfuncionario finsup ON finsup.id_funcionario = ((
...
/***********************************I-DEP-MAY-CD-1-13/07/2020*****************************************/
DROP VIEW cd.vcuenta_doc_fun_sup;
...
SELECT cd.id_cuenta_doc,
    ...
    fu.email_empresa AS correo_solicitante,
    mo.codigo AS moneda,
    finsup.desc_funcionario1 AS funcionario_responsable,
    finsup.email_empresa AS correo_responsable
FROM cd.tcuenta_doc cd
     JOIN orga.vfuncionario f ON f.id_funcionario = cd.id_funcionario
     JOIN orga.tfuncionario fu ON fu.id_funcionario = cd.id_funcionario
     ...
     LEFT JOIN orga.tfuncionario_cuenta_bancaria fcb ON
         fcb.id_funcionario_cuenta_bancaria = cd.id_funcionario_cuenta_bancaria
     JOIN orga.vfuncionario_persona finsup ON finsup.id_funcionario = ((
    SELECT f_get_aprobadores_x_funcionario.id_funcionario
    FROM orga.f_get_aprobadores_x_funcionario(cd.fecha, cd.id_funcionario,
        'todos'::character varying, 'no'::character varying, '4'::character varying, 'ninguno'::character varying) f_get_aprobadores_x_funcionario(id_funcionario integer)
    ));
/***********************************F-DEP-MAY-CD-1-13/07/2020*****************************************/

/***********************************I-DEP-MAY-CD-0-16/07/2020*****************************************/
DROP VIEW cd.vcuenta_doc_fun_sup;
...
FROM cd.tcuenta_doc cd
    ...
    SELECT f_get_aprobadores_x_funcionario.id_funcionario
    FROM orga.f_get_aprobadores_x_funcionario(cd.fecha, cd.id_funcionario,
        'todos'::character varying, 'no'::character varying, 'todos'::character varying, 'ninguno'::character varying) f_get_aprobadores_x_funcionario(id_funcionario integer)
    ));

/***********************************F-DEP-MAY-CD-0-16/07/2020*****************************************/

/***********************************I-DEP-MAY-CD-0-20/07/2020*****************************************/
DROP VIEW cd.vcuenta_doc_fun_sup;
...
FROM cd.tcuenta_doc cd
    ...
    FROM orga.f_get_aprobado_superior_x_funcionario(cd.fecha,
        cd.id_funcionario, 'todos'::character varying) id_funcionario(id_funcionario)
    ));


/***********************************F-DEP-MAY-CD-0-20/07/2020*****************************************/

/***********************************I-DEP-MAY-CD-0-11/11/2020*****************************************/
DROP VIEW cd.vcuenta_doc_fun_sup;

CREATE OR REPLACE VIEW cd.vcuenta_doc_fun_sup(
    id_cuenta_doc,
    id_funcionario,
    id_depto_conta,
    fecha_cbte,
...
AS
  ...
  FROM cd.tcuenta_doc cd
       ...
       JOIN orga.vfuncionario_persona finsup ON finsup.id_funcionario =((
                                                                          ...
                                                                          FROM
                                                                            orga.f_get_aprobado_superior_x_funcionario_v3
                                                                            (
                                                                            cd.fecha
                                                                            )
                                                                            id_funcionario
