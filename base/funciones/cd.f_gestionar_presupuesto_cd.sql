      ...
      IF p_operacion = 'comprometer' THEN
       ...
       ELSIF p_operacion = 'verificar' THEN
          ...
          IF v_pre_verificar_categoria = 'no' THEN
             ...
             --(17-09-2019)se pone esta condicion , por que los pagos en fondos en avance no figuran presupuestariamente
             --las estaciones Internacionales no mostrara el aviso ni controlara presupuestariamente
...
ALTER FUNCTION cd.f_gestionar_presupuesto_cd (p_id_cuenta_doc integer, p_id_usuario integer, p_operacion varchar, p_conexion varchar)
  OWNER TO postgres;